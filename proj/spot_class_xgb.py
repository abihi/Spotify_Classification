...
def modelfit(alg, dtrain, targets, final_pred, useTrainCV=True, cv_folds=10, early_stopping_rounds=1000):
    ...
    alg.fit(dtrain, targets, eval_metric=['auc'], eval_set=eval_set, verbose=False)
